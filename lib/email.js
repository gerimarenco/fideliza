...
export async function enviarEmailBienvenida({ email, passwordGenerada, puntosAcreditados, puntosTotales, negocioNombre }) {
  ...
  try {
    await resend.emails.send({
      ...
      html: `
        <p>¡Hola!</p>
        <p>Con tu compra en <strong>${negocioNombre}</strong> arrancaste a sumar puntos en Fideliza, su programa de fidelización de clientes — ya sumaste <strong>${puntosAcreditados} puntos</strong>.</p>
...
export async function enviarEmailPuntosAcreditados({ email, puntosAcreditados, puntosTotales, negocioNombre }) {
  ...
  try {
    await resend.emails.send({
      ...
      html: `
        <p>¡Gracias por tu compra en <strong>${negocioNombre}</strong>!</p>
