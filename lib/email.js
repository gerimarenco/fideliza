...
export async function enviarEmailBienvenida({ email, passwordGenerada, puntosAcreditados, puntosTotales, negocioNombre }) {
  ...
  try {
    await resend.emails.send({
      ...
      html: `
        <p>¡Hola!</p>
        <p>Con tu compra en <strong>${negocioNombreSeguro}</strong> arrancaste a sumar puntos en Fideliza, su programa de fidelización de clientes — ya sumaste <strong>${puntosAcreditados} puntos</strong>.</p>
