...
// quiere premiar. Cecilia los subió (2026-09-14) porque con "1 punto cada
// $100" (puntosXPeso de Peperina) los primeros números resultaban
// demasiado fáciles de alcanzar con el gasto real de una clienta -- estos
// equivalen a $300mil / $800mil / $1,5M / $3M gastados acumulados, pero
// siguen siendo puntos de partida razonables, no algo atado a una fórmula
// exacta: fácil de ajustar acá si en la práctica no reflejan bien a los
// clientes reales de cada negocio (o si puntosXPeso cambia).
const NIVELES = [
  { nombre: 'VIP', minimo: 30000, color: '#7c3aed' },
  { nombre: 'Diamante', minimo: 15000, color: '#0ea5e9' },
  { nombre: 'Oro', minimo: 8000, color: '#f59e0b' },
  { nombre: 'Plata', minimo: 3000, color: '#9ca3af' },
